...
export default function AboutPage() {
  return (
    <div className="ryze-container py-12">
      <Reveal>
        <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-neon-pink">{t('about.manifesto')}</p>
        <h1 className="mt-3 font-display text-5xl font-black leading-none sm:text-7xl">
          {t('about.dontSellGear')}<br />
          <span className="neon-text-static">{t('about.armPlayers')}</span>
        </h1>
      </Reveal>
      ...
      <div className="mt-20">
        <Reveal>
          <div className="glass-card relative overflow-hidden p-8 sm:p-14">
            ...
            <p className="relative mt-3 text-white/50">{t('about.collective')}</p>
          </div>
        </Reveal>
      </div>
    </div>
